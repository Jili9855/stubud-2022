...
mainAudio.addEventListener("timeupdate", (e)=>{
    ...
    let musicCurrentTime = wrapper.querySelector(".current-time"), musicDuartion = wrapper.querySelector(".max-duration");
